...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_hero_service__ = __webpack_require__("../../../../../src/app/services/hero.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_exchange_service__ = __webpack_require__("../../../../../src/app/services/exchange.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_7__services_hero_service__["a" /* HeroService */], __WEBPACK_IMPORTED_MODULE_9__services_message_service__["a" /* MessageService */], __WEBPACK_IMPORTED_MODULE_12__services_exchange_service__["a" /* ExchangeService */]],
...
module.exports = "<h3>Assets</h3>\n<div class=\"exchange\" *ngFor=\"let exchange of exchanges\">\n  {{exchange}}\n  <li *ngFor=\"let asset of assets[exchange]\">\n  <a>\n    <span class=\"badge\">{{ asset.symbol }}</span> {{ asset.amount }}\n  </a>\n</li>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_asset__ = __webpack_require__("../../../../../src/app/services/asset.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardComponent = (function () {
    function DashboardComponent(heroService, exchangeService) {
        this.heroService = heroService;
        this.exchangeService = exchangeService;
        this.heroes = [];
        this.assets = {};
        this.exchanges = __WEBPACK_IMPORTED_MODULE_3__services_asset__["a" /* Exchanges */];
    }
    DashboardComponent.prototype.ngOnInit = function () {
        for (var _i = 0, _a = this.exchanges; _i < _a.length; _i++) {
            var name_1 = _a[_i];
            this.getBalance(name_1);
        }
    };
    DashboardComponent.prototype.getBalance = function (name) {
        var _this = this;
        this.exchangeService.getBalance(name)
            .subscribe(function (assets) {
            console.log(assets);
            _this.assets[name] = assets;
        });
    };
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_hero_service__["a" /* HeroService */],
            __WEBPACK_IMPORTED_MODULE_2__services_exchange_service__["a" /* ExchangeService */]])
    ], DashboardComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_hero__ = __webpack_require__("../../../../../src/app/services/hero.ts");
...
var HeroDetailComponent = (function () {
    ...
    __decorate([
        ...
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1__services_hero__["a" /* Hero */])
    ...
    HeroDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */],
            __WEBPACK_IMPORTED_MODULE_4__services_hero_service__["a" /* HeroService */],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Exchanges; });
/**
...
var ExchangeService = (function () {
    function ExchangeService(http) {
        this.http = http;
        this.server_url = __WEBPACK_IMPORTED_MODULE_2__config__["a" /* Config */].server_url;
    }
    ExchangeService.prototype.getBalance = function (name) {
        var url = this.server_url + "/" + name + "/balance";
        return this.http.get(url);
    };
    ExchangeService.prototype.ngOnInit = function () {
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mock_heroes__ = __webpack_require__("../../../../../src/app/services/mock-heroes.ts");
...
var HeroService = (function () {
    ...
    HeroService.prototype.selectedHero = function (hero) {
